using ConfirmationService.Utilidades;
using ConfirmationService.Services.Contracts;
using ConfirmationService.Services.Implementation;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "ConfirmationService", Version = "v1" });
});
